const icons = {
  ...
  flame: (
    <>
      <path d="M12.5 2.5c.8 4-2.8 5.1-2.8 8.2 0 1.5.9 2.4 2 2.9-.2-2.2 1-3.6 2.5-4.7 1.5 1.5 3.3 3.7 3.3 6.5A5.5 5.5 0 0 1 6.5 15c0-4.8 3.7-7.5 6-12.5Z" />
      <path d="M10 18c.3 1.8 1.4 2.8 2.8 3.5" />
    </>
  ),
  end: (
    <>
